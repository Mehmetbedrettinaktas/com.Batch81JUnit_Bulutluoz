...
public class C06_ReadExcel {
    ...
    public void readExcelTest() throws IOException {
        ...
        // excel dosyasindaki tum verileri calass'imiza alip
        // bir Java objesine store edelim boylece her seferinde excel'e ulasip
        // satir, sutun vs... ugrasmayalim
        ...
        for (int i = 0; i <=sonSatirIndex ; i++) {
            ...
            // value ise i.satirindaki 1,2 ve 3 indexdeki datalarin birlesimi olacak
